...
def collect_data(paths):
    ...
    segments_files_path = os.path.join(paths.data_root, 'features_charades_ground_truth_segmentation', 'segments_svm_format')
    segments_feature_path = os.path.join(paths.data_root, 'features_charades_ground_truth_segmentation', 'features_binary_svm_format')
    ...
    # pickle.dump(data, open(os.path.join(paths.tmp_root, 'charades_data.p'), 'wb'))
    # pickle.dump(sequence_ids, open(os.path.join(paths.tmp_root, 'charades_data_list.p'), 'wb'))
