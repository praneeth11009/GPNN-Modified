...
def parse_arguments():
    ...
    # parser.add_argument('--log-root', default=os.path.join(paths.log_root, 'charades/graph'), help='log files path')
    # parser.add_argument('--resume', default=os.path.join(paths.tmp_root, 'checkpoints/charades/graph'), help='path to latest checkpoint')
